...
public class GuoLogDetector extends Detector implements Detector.JavaScanner {
    private static final Class<? extends Detector> DETECTOR_CLASS = GuoLogDetector.class;
    ...
    private static final String ISSUE_DESCRIPTION = "Guo WARING!:You should use our {AppLog}";
